...
public class LecternControllerMovingInteraction extends MovingInteractionBehaviour {
    ...
    public boolean handlePlayerInteraction(Player player, InteractionHand activeHand, BlockPos pos, AbstractContraptionEntity contraptionEntity) {
        ...
        player.setItemInHand(InteractionHand.MAIN_HAND, createLinkedController(player.level(), data));
    ...
    private static ItemStack createLinkedController(Level level, CompoundTag data) {
